...
//        model.setBody("abc");
//        model.setSubject("abcdefg");
//        model.setOutTradeNo("123456789");
//        model.setTimeoutExpress("30m");
//        model.setTotalAmount("1.23");
...
//回调地址 http://wangxq014.vaiwan.com/payClient/notify
//        alipayTradePrecreateRequest.setNotifyUrl(aliPayBo.getNotifyUrl());
